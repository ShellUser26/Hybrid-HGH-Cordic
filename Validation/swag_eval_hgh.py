...
# CONFIGURATION
# ==============================================================================
# Pointing to your successfully trained baseline model!
MODEL_PATH = "./swag_base_e_model/best_hardware_baseline"
...
def run_final_benchmark():
    print("\n" + "="*70)
    print("      FINAL HARDWARE BENCHMARK: SWAG (3-PHASE EVALUATION)")
    print("="*70)
    ...
    # ---------------------------------------------------------
    print("\n\n" + "="*70)
    print("      FINAL HARDWARE BENCHMARK RESULTS: SWAG (BERT-BASE)")
    print("="*70)
